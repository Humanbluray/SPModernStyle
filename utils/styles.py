...
login_style: dict = dict(
    ...
    hint_style=ft.TextStyle(size=14, font_family='PPM', color="black"),
    text_style=ft.TextStyle(size=14, font_family='PPM', color='black'),
    label_style=ft.TextStyle(size=14, font_family="PPM", color='black'),
...
ct_style: dict = dict(
    ...
    padding=0,
    bgcolor=ft.Colors.with_opacity(0.4, ft.Colors.WHITE),  # Surcouche semi-transparente
...
datatable_style: dict = dict(
    ...
    column_spacing=20,
    data_text_style=ft.TextStyle(size=14, font_family='PPM'),
    heading_text_style=ft.TextStyle(size=14, font_family='PPR', color="white"),

)
dash_style: dict = dict(
    padding=10,
    border_radius=16,
)
